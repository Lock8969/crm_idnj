                ...
                <div id="contactInfo" class="collapse show">
                    <div class="card-body">
                        <form action="update_db.php" method="POST">
                            <input type="hidden" name="table" value="client_information">
                            <input type="hidden" name="record_id" value="<?php echo htmlspecialchars($client['id']); ?>">
                            <input type="hidden" name="redirect_url" value="client_details.php">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg mb-0" id="address1" name="address1"
                                           value="<?php echo htmlspecialchars($client['address1']); ?>" required>
                                </div>
                            </div>
    ...
    <div class="card shadow-sm">
        ...
        <div id="vehicleInfo" class="collapse show">
            <div class="card-body">
                ...
                <form action="update_db.php" method="POST">
                    <input type="hidden" name="table" value="vehicle_information">
                    ...
                    <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select id="model" name="model_id" class="form-control" <?php echo empty($vehicle['make_id']) ? 'disabled' : ''; ?>>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select id="hybrid" name="hybrid" class="form-control">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select id="start_system" name="start_system" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea id="notes" name="notes" class="form-control"><?php echo htmlspecialchars($vehicle['notes']); ?></textarea>
                            </div>
                        </div>
                    </div>
